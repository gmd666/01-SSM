                                        ...
                                        <div id="menu_5" style="DISPLAY: none">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td nowrap><a href="${pageContext.request.contextPath}/getLabels.do?nowPage=1" target="mainFrame" class="a03">栏目管理</a></td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                                                    <td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
                                                    <td nowrap><a href="${pageContext.request.contextPath}/html/news/newsPost.jsp" target="mainFrame" class="a03">新闻发布</a></td>
                                                </tr>
                                            </table>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="19"><img src="../images/tree_07.gif" width="19" height="20"></td>
                                                    <td width="19"><img src="../images/tree_14.gif" width="19" height="20"></td>
                                                    <td nowrap><a href="${pageContext.request.contextPath}/html/news/newsPreserve_commonSearch.jsp" target="mainFrame" class="a03">新闻维护</a></td>
                                                </tr>
                                            </table>
                                        </div>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
