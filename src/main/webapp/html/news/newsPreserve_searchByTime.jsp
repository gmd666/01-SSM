...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
    <td width="79%" class="td_page style1">--<a href="newsPreserve_commonSearch.jsp">普通查询</a>--按时间查询--</td>
</table>
    ...
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
        ...
        <tr>
            <td class="td07" align="center"><input type="checkbox" name="checkbox"
                                                   ...
                                                   value="checkbox"></td>
            <td class="td07"><a href="#" onClick="javascript:windowOpen('lookDetailNews.jsp','','',670,450,'','','')">我猜</a></td>
            <td class="td07">我猜</td>
